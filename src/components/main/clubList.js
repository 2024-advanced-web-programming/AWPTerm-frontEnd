...
const ClubList = () => {
  ...
  const handleCardClick = (club) => {
    ...
    Swal.fire({
        ...
        imageAlt: "대표 사진",
        title: club.name,
        html: `${club.introduction ? club.introduction : '설명 없음'}<br>회장 : ${club.presidentName} | 부회장 : ${club.vicePresidentName ? club.vicePresidentName : '없음'} | 총무 : ${club.secretaryName ? club.secretaryName : '없음'}<br>정기모임시간 :${club.regularMeetingTime ? club.regularMeetingTime : '없음'}`,
